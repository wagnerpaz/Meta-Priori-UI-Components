...
public final class Range<T extends Comparable<T>> {
	 ...
	 */
	public Range(final T referenceValue, final T lowerBound, final T upperBound) throws IllegalArgumentException {
		...
		this.refereceValue = referenceValue;
	}
